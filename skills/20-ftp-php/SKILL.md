...
**先决條件**：你已經完成技能 19，擁有 ProFreeHost 帳號、已上傳網頁、並建立了 MySQL 資料庫。
...
- 資料庫使用者
- 資料庫密碼
- 資料庫主機（ProFreeHost 通常是 `localhost`）

## 2. 讓 AI 幫你寫 PHP 程式

對你的 AI 編輯器說：
```
我有一個 ProFreeHost 免費主機，已建立 MySQL 資料庫。
資料庫資訊如下：
- 資料庫名稱：[貼上你的資料庫名稱]
- 使用者：[貼上你的使用者]
- 密碼：[貼上你的密碼]
...
打開瀏覽器，輸入 `https://你的帳號.profreehost.com/index.php`
...
對 AI 說：
```
我已經可以成功連線 ProFreeHost 的 MySQL 資料庫了。
請幫我寫一個「留言板」PHP 程式：
